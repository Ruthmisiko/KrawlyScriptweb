    ...
    <div id="services" class="container mx-auto px-5">
        <section class="py-16">
            <div class="w-4/5 md:w-3/5 mx-auto">
                ...
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Our aim is to deliver high-quality, well-researched, and engaging written content that meets your specific needs. Whether it's academic writing, persuasive copy, or insightful articles, we ensure originality, clarity, and impact in every piece we create.</p>
            </div>
